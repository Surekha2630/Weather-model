...
def main():
    ...
    try:
        with open('single0369.txt', 'r') as file:
        ...
        for line in lines:
            ...
            plt.plot(time_values, temperature_values, marker='o', color='red', linestyle='-', label=f'a={a}, b={b}, c={c}')
        ...
        print("File not found. Please make sure 'single0369.txt' exists.")
main()
